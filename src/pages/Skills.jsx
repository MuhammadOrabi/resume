export default function Skills() {
  return (
    <div className="mt-12 spaced-y-10">
      <div>
        ...
        <div className="text-grey-darkest text-base leading-normal mt-1">
          <ul>
            ...
            <li>Node.js, NestJS, Laravel, REST APIs</li>
      ...
      <div>
        <p className="text-lg text-black font-bold">Tools:</p>
        <div className="text-grey-darkest text-base leading-normal mt-1">
          <ul>
            <li>GNU/Linux, Bash scripting, Git, GitHub/GitLab workflows</li>
            <li>Docker, Kubernetes basics, CI/CD (GitHub Actions, GitLab CI)</li>
