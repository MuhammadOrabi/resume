  ...
  return (
    <div className="mt-12 spaced-y-10">
      <div className="surface-card">
        ...
        <p className="text-grey-darkest text-base leading-normal mt-1">Bachelor's degree in Computer Science.</p>
      </div>
      <div className="surface-card">
        <a href="https://www.freecodecamp.org/" className="text-lg text-black font-bold no-underline hover:underline">FreeCodeCamp</a>
        <p className="text-grey-darkest text-base leading-normal mt-1">Full-Stack Web Development track.</p>
